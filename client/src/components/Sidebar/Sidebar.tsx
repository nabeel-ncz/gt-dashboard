...
export default function Sidebar({
    ...
    return (
        <div className={`w-full h-screen sticky bg-[#000] pt-4 pl-4 xl:block ${open ? 'block z-10 bg-[rgba(0,0,0,0.7)] backdrop-blur-lg px-6' : 'hidden'}`}>
            ...
            <div className="flex flex-col items-start pt-8">
                ...
                <div className="flex flex-col items-start pt-4 gap-8">
                    <NavLink to='/inbox' className={({ isActive }) => isActive ? "opacity-100" : "opacity-50"}>
                        <div className="flex items-center justify-start gap-2 cursor-pointer">
                            <AiFillMessage size={"22"} color={"#fff"} />
                            <h2 className="font-normal text-sm text-white">Inbox</h2>
                        </div>
                    </NavLink>
                    <NavLink to='/channels' className={({ isActive }) => isActive ? "opacity-100" : "opacity-50"}>
                        <div className="flex items-center justify-start gap-2 cursor-pointer">
                            <MdDashboard size={"22"} color={"#fff"} />
                            <h2 className="font-normal text-sm text-white">Channels</h2>
                        </div>
                    </NavLink>
                    <NavLink to='/profiles' className={({ isActive }) => isActive ? "opacity-100" : "opacity-50"}>
                        <div className="flex items-center justify-start gap-2 cursor-pointer">
                            <FaUser size={"22"} color={"#fff"} />
                            <h2 className="font-normal text-sm text-white">Buissness Profiles</h2>
                        </div>
                    </NavLink>
                    <NavLink to='/insights' className={({ isActive }) => isActive ? "opacity-100" : "opacity-50"}>
                        <div className="flex items-center justify-start gap-2 cursor-pointer">
            ...
            <div className="flex flex-col items-start pt-8">
                ...
                <div className="flex flex-col items-start pt-4 gap-8">
                    <NavLink to='/roles' className={({ isActive }) => isActive ? "opacity-100" : "opacity-50"}>
                        <div className="flex items-center justify-start gap-2 cursor-pointer">
                            <LuPlusCircle size={"22"} color={"#fff"} />
                            <h2 className="font-normal text-sm text-white">Create Roles</h2>
                        </div>
                    </NavLink>
                    <NavLink to='/users' className={({ isActive }) => isActive ? "opacity-100" : "opacity-50"}>
                        <div className="flex items-center justify-start gap-2 cursor-pointer">
                            <FaUserPlus size={"22"} color={"#fff"} />
                            <h2 className="font-normal text-sm text-white">Create Users</h2>
                        </div>
                    </NavLink>
                    <NavLink to='/settings' className={({ isActive }) => isActive ? "opacity-100" : "opacity-50"}>
                        <div className="flex items-center justify-start gap-2 cursor-pointer">
